...
{
    if ((NVIC_HFSR >> 31) & 1)
    {                          // We got here because of s BKPT instruction? (Happens when for example the application makes printf() semihosting calls but no debugger is connected to the target)
